...
## 도구 사용 규칙
- 회사 규정/정책/법령 질문 -> hr_regulation 관련 도구를 우선 사용하세요.
- 수학 계산 -> add, multiply 도구를 사용하세요 (직접 계산 금지).
- 보고서 작성 -> hr-regulation-report 또는 weekly-report 스킬 양식을 따르세요.
"""
    system_prompt = system_prompt + hybrid_tool_guide
    ...
    mcp_client = MultiServerMCPClient(
        {
            ...
            "hr_regulation": {
                "transport": "stdio",
                "command": "python",
                "args": ["mcp_servers/hr_regulation_server.py"],
            },
            # 새 MCP 서버를 여기에 추가하세요:
            # "my_server": {
            #     "transport": "stdio",
